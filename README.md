...
yet another crafting interpreters project
...
- [offical language specification](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/language-specification/readme)
- [dotnet API reference](https://learn.microsoft.com/en-us/dotnet/api/)
- [dotnet System reference](https://learn.microsoft.com/en-us/dotnet/api/system)
